...
pub use attrs::{attribute_list_contains_handle_list, attribute_list_contains_parent_process};
pub(crate) use attrs::{
    dump_attr_list_for_overlay_spawn, image_name_attr_mut, readable_region,
};
// Only the test modules (split out into sibling files) reach for this one.
#[cfg(test)]
pub(crate) use attrs::image_name_from_attr_list;
